...
1. [JVM 中内存模型是怎样的，简述新生代与老年代的区别？新生代有哪些区，作用是什么？](JVM/JVM 中内存模型是怎样的，简述新生代与老年代的区别？新生代有哪些区，作用是什么？.md)🌛
2. [如何判断对象是否可以被回收（1引用计数2可达性分析）](JVM/如何判断对象是否可以被回收（1引用计数2可达性分析）.md)🌛
3. [JVM常用垃圾回收算法，讲一下CMS原理](JVM/JVM常用垃圾回收算法，讲一下CMS原理.md)🌛
4. [Java 中垃圾回收机制中如何判断对象需要回收？常见的 GC 回收算法有哪些？](JVM/Java 中垃圾回收机制中如何判断对象需要回收？常见的 GC 回收算法有哪些？.md)🌛
5. [JVM 是怎么去调优的？简述过程和调优的结果](JVM/JVM 是怎么去调优的？简述过程和调优的结果.md)🌛
6. 如何监控 GC✨
