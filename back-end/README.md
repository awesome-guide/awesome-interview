...
4. 启动线程方法 start()和 run()有什么区别？![](../images/猕猴桃.png)
5. 线程中的 wait()和 sleep()方法有什么区别？![](../images/猕猴桃.png)
6. 为什么wait, notify 和 notifyAll这些方法不在thread类里面？![](../images/猕猴桃.png)
7. 为什么wait和notify方法要在同步块中调用？![](../images/猕猴桃.png)
8. 讲下join,yield方法的作用,以及什么场合用它们？![](../images/猕猴桃.png)
9. 为什么Thread类的sleep()和yield()方法是静态的？![](../images/猕猴桃.png)
...
30. CyclicBarrier 和 CountDownLatch 的区别？![](../images/樱桃.png)
31. Fork/Join 框架是干什么的？![](../images/樱桃.png)
32. 常用的线程池模式以及不同线程池的使用场景？![](../images/樱桃.png)
33. BlockingQueue的原理是什么![](../images/樱桃.png)
34. 如何确保N个线程可以访问N个资源同时又不导致死锁？![](../images/樱桃.png)
33. 有三个线程 T1，T2，T3，怎么确保它们按顺序执行？@A![img](file:///Users/zhangbo/Documents/workspace/awesome-interview/images/%E8%8A%92%E6%9E%9C.png?lastModify=1605700951)
34. 多线程交替打印ABC10次的多种实现方法(请给出至少四种实现思路)（应该有5种）![](../images/芒果.png)
35. 如何写代码来解决生产者消费者问题？![](../images/芒果.png)
36. 你如何确保main()方法所在的线程是Java程序最后结束的线程？![](../images/芒果.png)
37. 同步方法和同步块，哪个是更好的选择？![](../images/芒果.png)
38. 数组A内容为 1,2,3,4...52 ,数组B内容为26个英文字母，使用两个线程分别输入两个数组，打印内容为：12a34b56c78e....... 这样的规律![](../images/芒果.png)
39. 列举出一般情况下线程中断的几种方式,并说明他们之间的优缺点,并且说明那种中断方式最好![](../images/芒果.png)
...
12. AQS 中独占锁和共享锁的操作流程大体描述一下@D🍐
13. 重入锁有什么好处，什么时候考虑用   @D🍐
14. 读写锁有什么好处，什么时候考虑用？读锁是什么类型的锁，写锁呢？🍐
15. 说下读写锁里的锁降级流程，什么时候可以考虑用这个机制🍌
16. park 方法是怎么实现的🍌
17. 锁的等待通知机制 Condition 是怎么实现的，有了线程的等待通知机制为什么还要设计 Condition？🍌
18. 死锁怎么产生的，如何避免，自己写一个死锁🍌
19. 说说 Java 中有哪些锁🍌
20. sleep、wait、park、Condition 都能让线程等待，有什么区别？🍌
