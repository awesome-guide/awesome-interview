...
11. 为什么Java不支持运算符重载？`@B`![](../images/柠檬.png)
12. 为什么Java中不支持多重继承？ `@B`![](../images/柠檬.png)
13. Java类初始化顺序 `@B`![](../images/柠檬.png)
14. Java 类的加载流程是怎样的？什么是双亲委派机制？@B![](../images/柠檬.png)
...
31. int 和Integer谁占用的内存更多?![]@D(../images/牛油果.png)
